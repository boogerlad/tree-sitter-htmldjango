...
module.exports = grammar({
  ...
  rules: {
    ...
    django_if_open: $ => seq(
      ...
      'if',
      $._django_inner_ws,
      field('condition', $.test_expression),
      optional($._django_inner_ws),
      $._django_tag_close,
    ),
    ...
    django_for_open: $ => seq(
      ...
      'for',
      $._django_inner_ws,
      field('target', $.loop_variables),
      $._django_inner_ws,
      'in',
      $._django_inner_ws,
      field('iterable', $.filter_expression),
    ...
    django_block_open: $ => seq(
      ...
      'block',
      $._django_inner_ws,
      field('name', alias($.identifier, $.block_name)),
      optional($._django_inner_ws),
      $._django_tag_close,
    ),
    ...
    django_endblock: $ => seq(
      ...
      optional($._django_inner_ws),
      'endblock',
      optional(seq($._django_inner_ws, field('name', alias($.identifier, $.block_name)))),
      optional($._django_inner_ws),
      $._django_tag_close,
    ),
    ...
    django_extends_tag: $ => seq(
      ...
      'extends',
      $._django_inner_ws,
      field('template', $.filter_expression),
      optional($._django_inner_ws),
      $._django_tag_close,
    ),
    ...
    django_url_tag: $ => seq(
      ...
      'url',
      $._django_inner_ws,
      field('url_name', $.filter_expression),
      repeat(seq(
        $._django_inner_ws,
        choice($.named_argument, $.filter_expression),
      )),
      optional(seq($._django_inner_ws, 'as', $._django_inner_ws, field('alias', alias($.identifier, $.variable_name)))),
      optional($._django_inner_ws),
      $._django_tag_close,
    ),
    ...
    django_cycle_tag: $ => seq(
      ...
      $._django_inner_ws,
      choice(
        field('name', alias($.identifier, $.cycle_name)),
        seq(
          $.cycle_value,
          repeat(seq($._django_inner_ws, $.cycle_value)),
          optional(seq($._django_inner_ws, 'as', $._django_inner_ws, field('alias', alias($.identifier, $.variable_name)), optional(seq($._django_inner_ws, alias('silent', $.silent))))),
        ),
      ),
      optional($._django_inner_ws),
      $._django_tag_close,
    ...
    django_regroup_tag: $ => seq(
      ...
      'regroup',
      $._django_inner_ws,
      field('source', $.filter_expression),
      $._django_inner_ws,
      'by',
      $._django_inner_ws,
      field('grouper', $.lookup),
      $._django_inner_ws,
      'as',
      $._django_inner_ws,
      field('alias', alias($.identifier, $.variable_name)),
      optional($._django_inner_ws),
      $._django_tag_close,
    ),
    ...
    django_widthratio_tag: $ => seq(
      ...
      field('value', $.filter_expression),
      $._django_inner_ws,
      field('max_value', $.filter_expression),
      $._django_inner_ws,
      field('max_width', $.filter_expression),
      optional(seq($._django_inner_ws, 'as', $._django_inner_ws, field('alias', alias($.identifier, $.variable_name)))),
      optional($._django_inner_ws),
      $._django_tag_close,
    ),
    ...
    django_lorem_tag: $ => seq(
      ...
      optional($._django_inner_ws),
      'lorem',
      optional(seq($._django_inner_ws, field('count', $.filter_expression))),
    ...
    django_resetcycle_tag: $ => seq(
      ...
      optional($._django_inner_ws),
      'resetcycle',
      optional(seq($._django_inner_ws, field('name', alias($.identifier, $.cycle_name)))),
      optional($._django_inner_ws),
      $._django_tag_close,
    ),
    ...
    django_partialdef_block: $ => seq(
      ...
      'partialdef',
      $._django_inner_ws,
      field('name', alias($.identifier, $.partial_name)),
      ...
      optional($._django_inner_ws),
      'endpartialdef',
      optional(seq($._django_inner_ws, field('end_name', alias($.identifier, $.partial_name)))),
      optional($._django_inner_ws),
      $._django_tag_close,
    ),
    ...
    filter_call: $ => prec.left(seq(
      ...
      optional(seq(
        alias($._filter_colon, ':'),
        field('argument', $.filter_argument),
      )),
    )),
